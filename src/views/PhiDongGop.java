...
public class PhiDongGop extends javax.swing.JPanel {
    ...
    public PhiDongGop(JFrame parentFrame) {
        ...
        jComboBoxNam.setSelectedItem(nam);
    }
            ...
            if (sotienText.getText().equalsIgnoreCase("")) {
                ...
                if (m.find()) {
                    ...
                    if (!idDG.equalsIgnoreCase("")) {
                        ...
                        DongGopModel dgm = new DongGopModel();
                        SuKienModel sk1 = skDAO.findByNameAndNam(suKien, nam);
                        dgm.setIdSuKien(sk1.getIdSuKien());
                        dgm.setSoTien(Integer.valueOf(sotienText.getText()));
                        Timestamp a = new Timestamp(System.currentTimeMillis());
                        a.setYear(Integer.valueOf(nam) - 1900);
                        dgm.setNgayDong(a);
                        //System.out.println(a);
                        String MaHK = String.valueOf(pdgjTable1.getValueAt(row, 1));
                        HoKhauModel hk = hkdao.findByMaHK(MaHK);
                        dgm.setIdHoKhau(hk.getID());
                        DongGopDAO.save(dgm);
                        dtm.setRowCount(0);
                        setData();
                        JOptionPane.showMessageDialog(PhiDongGop.this, "Thao tác thành công!");
